...
const resources = {
  ...
  ar: {
    translation: {
      ...
      categories: { all: "الكل", action: "أكشن", adventure: "مغامرة", comedy: "كوميديا", drama: "دراما", fantasy: "خيال", horror: "رعب", isekai: "إيسيكاي", mystery: "غموض", romance: "رومانسية", sciFi: "خيال علمي", sliceOfLife: "شريحة من الحياة" },
  ...
  fr: {
    translation: {
      ...
      categories: { all: "Tout", action: "Action", adventure: "Aventure", comedy: "Comédie", drama: "Drame", fantasy: "Fantaisie", horror: "Horreur", isekai: "Isekai", mystery: "Mystère", romance: "Romance", sciFi: "Science-fiction", sliceOfLife: "Tranche de vie" },
  ...
  es: {
    translation: {
      ...
      categories: { all: "Todo", action: "Acción", adventure: "Aventura", comedy: "Comedia", drama: "Drama", fantasy: "Fantasía", horror: "Terror", isekai: "Isekai", mystery: "Misterio", romance: "Romance", sciFi: "Ciencia ficción", sliceOfLife: "Recuentos de la vida" },
  ...
  "zh-CN": {
    translation: {
      ...
      categories: { all: "全部", action: "动作", adventure: "冒险", comedy: "喜剧", drama: "剧情", fantasy: "奇幻", horror: "恐怖", isekai: "异世界", mystery: "悬疑", romance: "恋爱", sciFi: "科幻", sliceOfLife: "日常" },
